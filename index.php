  ...
  <div class="container-fluid">
    <nav class="navbar fixed-top navbar-expand-lg bg-dark">
      <div class="container">
        ...
        <div class="iso-img">
          <img class="ml-4" src="img/iso_certified.png" width="70" height="70" alt="" style="filter: brightness(10) saturate(0%);">
        </div>
...
<div class="container-fluid cover-image">
  <div class="container">
    <div class="row align-items-center">
      <div class="test_css" style="margin-top: 5rem!important;" data-aos="fade-right">
        <div class="mt-5">
        ...
        <h2 class="position-relative h2_custom">Quality, Timely deliveries and Client Satisfaction</h2>
      ...
      <div class="col-md-6 hidden_front">
...
<div class="container mt-adjust text-center">
  ...
  <div class="row">
    ...
    <div class="col-md-4 mt-5">
      <div class="card" data-aos="flip-up" data-aos-duration="800">
        <div class="card-body">
          <div class="d-flex align-items-center">
            <i class="bi-check-circle custom-icon"></i>
            <div class="px-4 flex custom-card-text">
              <h4>Projects Done</h4>
              <h5 class="text-success mt-3">100+</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-4 mt-5">
      <div class="card" data-aos="fade-right" data-aos-duration="800">
        <div class="card-body">
          <div class="d-flex align-items-center">
            <i class="bi-gear-fill custom-icon"></i>
            <div class="px-4 flex custom-card-text">
...
const line = document.querySelectorAll('.animation-line');
for(i=0;i<=line.length-1;i++){

    line[i].addEventListener('animationend', function() {
        try{
        line[i].style.animation = 'none';
    }
        catch{
            console.log(i)
        }
  ...
  slider.addEventListener('input', (e) => {
    var container = e.currentTarget.closest(".container-slider");
